<#macro commonStyle>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="${request.contextPath}/static/adminlte/lte_dist/css/AdminLTE.min.css">
    <!-- AdminLTE Skins. Choose a skin from the css/skins folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="${request.contextPath}/static/adminlte/lte_dist/css/skins/_all-skins.min.css">
...
<#macro commonScript>
	...
	<!-- AdminLTE App -->
	<script src="${request.contextPath}/static/adminlte/lte_dist/js/adminlte.min.js"></script>
	<!-- jquery.slimscroll -->
